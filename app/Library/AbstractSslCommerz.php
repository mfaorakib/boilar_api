...
abstract class AbstractSslCommerz implements SslCommerzInterface
{
     ...
     * @return mixed
     */
    protected function getStoreId(): mixed
    {
        return $this->storeId;
    }
     ...
     * @return mixed
     */
    protected function getStorePassword(): mixed
    {
     ...
     * @return mixed
     */
    protected function getApiUrl(): mixed
    {
        return $this->apiUrl;
    }
     ...
     * @return bool|string
     */
    public function callToApi($data, $header = [], $setLocalhost = false): bool|string
    {
        $curl = curl_init();
